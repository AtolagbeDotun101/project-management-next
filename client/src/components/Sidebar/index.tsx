...
const index = () => {
    ...
    ${isSidebarCollapsed ? "w-o hidden" : "w-64"}`
        ...
        <div className={sidebarClassNames}>
            ...
            <div className='flex h-[100%] w-full flex-col justify-start'>
                ...
                <div className='z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black'>
                    ...
                    {isSidebarCollapsed ? null : (
                        <button className='py-3' onClick={() => dispatch(setIsSidebarCollapsed(!isSidebarCollapsed))}>
                            <X className='h-6 text-gray-800 hover:text-gray-500 dark:text-white' />
                        </button>
                    )}
                </div>
                {/* team */}
                ...
                <nav className='z-10 w-full'>
                    ...
                    <SidebarLinks icon={User} label='User' href='/users' />
                    <SidebarLinks icon={Users} label='Team' href='/teams' />
                </nav>
    ...
    return (
        <Link href={href} className='w-full'>
            <div className={`relative flex items-center cursor-pointer gap-3 transition-colors
                 ...
                 ${isActive ? "bg-gray-100 text-white dark:bg-gray-600" : ""} justify-start py-5 px-3 `}>
                {isActive && (
